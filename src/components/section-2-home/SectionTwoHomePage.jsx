...
const SectionTwoHomePage = () => {
    return (
        <div className={'flex flex-col items-center p-8 w-full mt-20 bg-background-light relative overflow-hidden'}>
            ...
            <img src={Pizza} alt={'pizza'} className="absolute bottom-0 sm:bottom-auto lg:-top-[10px] right-0 w-[10%] min-w-[100px]"/>
            <div className={'flex w-[70%] md:w-[80%] justify-between relative'}>
                ...
                <div className={'hidden lg:flex items-center w-1/2 gap-5'}>
                    ...
                    <div className={'flex flex-col gap-5 w-[40%] justify-center mb-10 min-w-[140px]'}>
                        <FastFoodCards image={TestImage} className={'w-full h-auto object-cover rounded-md'}/>
                        <FastFoodCards image={TestImage} className={'w-full h-auto object-cover rounded-md'}/>
                    </div>
                </div>
                <div className={'w-full lg:w-[40%] flex flex-col justify-center'}>
                    <h1 className={'text-primary text-lg text-center lg:text-3xl lg:text-left font-bold mb-5 '}>We
                        ...
                        you</h1>
                    <p className={'text-primary/80 text-2xs sm:text-xs lg:text-normal'}>Burger Town is your go-to destination for
